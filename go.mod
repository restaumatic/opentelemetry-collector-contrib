...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/exporter/datadogagentexporter v0.0.0
...
replace github.com/open-telemetry/opentelemetry-collector-contrib/exporter/datadogagentexporter => ./exporter/datadogagentexporter
